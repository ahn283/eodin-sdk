...
object EodinAnalytics {
     ...
     * @Volatile (M2): cross-thread visibility 보장.
     */
    @Volatile
    ...
    private const val KEY_ENABLED = "eodin_enabled"   // MEDIUM-1 cross-platform parity
     ...
     *
     * Sends DELETE `${apiEndpoint}/events/user-data`. Local data is cleared
