...
// Status getters (4채널 parity — getter 또는 await 함수)
EodinAnalytics.getDeviceId();          // string | null
EodinAnalytics.getUserId();            // string | null
EodinAnalytics.getSessionId();         // string | null
EodinAnalytics.getAttribution();       // Attribution | null
...
EodinAnalytics.isEnabled();                   // boolean — 또는 getter (TS 표현 결정은 Phase 3)
